...
const destinationImages = {
  petra: "/petra-treasury-jordan.jpg",
  wadiRum: "/wadi-rum-desert-red-sand-dunes-dramatic-rock-forma.jpg",
  deadSea: "/dead-sea-floating-jordan.jpg",
  amman: "/amman-city-jordan-citadel.jpg",
  aqaba: "/aqaba-red-sea-beach.jpg",
}
...
export default function Header() {
  ...
  const jordanDestinations = [
    ...
    { title: t.destinations.wadiRum.name, href: "/destinations/wadi-rum", description: t.destinations.wadiRum.description, image: destinationImages.wadiRum },
    { title: t.destinations.deadSea.name, href: "/destinations/dead-sea", description: t.destinations.deadSea.description, image: destinationImages.deadSea },
    { title: t.destinations.amman.name, href: "/destinations/amman", description: t.destinations.amman.description, image: destinationImages.amman },
    { title: t.destinations.aqaba.name, href: "/destinations/aqaba", description: t.destinations.aqaba.description, image: destinationImages.aqaba },
  ]
